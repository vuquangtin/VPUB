...
{
    public partial class Frm2DetailInforBySerialNumber : Form
    {
        ...
        #region Contructors
        public Frm2DetailInforBySerialNumber(byte mode, String cardChip)
        {
            InitializeComponent();
        ...
        private void rbtnNotAttendMeeting_CheckChanged(object sender, EventArgs e)
        {
            if (rbtnNotAttendMeeting.Checked)
            {
                checkAttendMeeeting = false;
                //dgvListMeetingToday.ReadOnly = true;
                //panel4ListMeeting.Enabled = false;
                dgvListMeetingToday.Enabled = false;


            }
        }

        private void rbtnAttendMeeting_CheckChanged(object sender, EventArgs e)
        {
            if (rbtnAttendMeeting.Checked)
            {
                checkAttendMeeeting = true;
               // dgvListMeetingToday.ReadOnly = false;
               // panel4ListMeeting.Enabled = true;
                dgvListMeetingToday.Enabled = true;
        ...
        private void Frm2DetailInforBySerialNumber_FormClosing(object sender, FormClosingEventArgs e)
        {
        }
