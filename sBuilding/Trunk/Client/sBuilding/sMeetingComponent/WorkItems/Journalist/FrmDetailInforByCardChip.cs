...
{
    public partial class FrmDetailInforByCardChip : Form
    {
        ...
        #region Contructors
        public FrmDetailInforByCardChip(byte mode, String cardChip)
        {
            InitializeComponent();
        ...
        private void FrmDetailInforByCardChip_FormClosing(object sender, FormClosingEventArgs e)
        {
        }
