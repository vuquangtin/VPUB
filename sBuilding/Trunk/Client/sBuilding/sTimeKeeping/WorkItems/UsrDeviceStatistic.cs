...
{
    public partial class UsrDevicestatistic : CommonUserControl
    {
        #region Properties
        ...
        [CommandHandler(TimeCommandName.ShowDeviceStatistic)]
        public void ShowMemberMgtMainHandler(object s, EventArgs e)
        {
            UsrDevicestatistic uc = workItem.Items.Get<UsrDevicestatistic>(DefineName.DeviceStatistic);
            if (uc == null)
            {
                uc = workItem.Items.AddNew<UsrDevicestatistic>(DefineName.DeviceStatistic);
            }
            ...
            uc.Parent.Text = ResoucreLanguagesUtils.Instance.GetResoucreLanguages(rm, DefineName.MenuDeviceStatistic);
        }
