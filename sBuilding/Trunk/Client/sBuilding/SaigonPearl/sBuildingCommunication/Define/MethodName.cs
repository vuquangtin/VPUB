...
namespace sBuildingCommunication.Define
{
    public class MethodName
    {
        ...
        public static readonly String GET_LIST_MEMBER_BY_LIST_SUBORG_ID = @"getlistmemberbylistsuborgid";
        ...
        public static readonly String ACCESS_PROCESS_NOMAL = @"AccessProcessNomal";
