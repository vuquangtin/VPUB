...
namespace MainForm
{
    public partial class FrmChangePassworld : CommonControls.Custom.CommonDialog
    {
        ...
        public FrmChangePassworld([ServiceDependency]ILocalStorageService storageService)
        {
            InitializeComponent();
