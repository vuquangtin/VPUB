...
namespace sAccessControl.Device.Reader.MCR02
{
    public class CommandUtils
    {
        ...
        //Execute Buzzer
        private static String BUZZER = @"BUZZER;50;2";
        ...
        {
            return string.Format(BUZZER +","+ ROLE1, milliseconds);
        }
        public static String OpenDoorByMilliseconds(int milliseconds, string message)
        {
            return string.Format(BUZZER + "," + ROLE1 + "," + LCDCLR + "," + LCDSET, milliseconds, message);
        }

        //Relay-2 ON or OFF all the time. 
        public static String OpenDoor()
        {
            return string.Format(BUZZER + ROLE1, "ON");
        }
        public static String OpenDoor(string message)
        {
            return string.Format(BUZZER + "," + ROLE1 + "," + LCDCLR + "," + LCDSET, "ON", message);
        }

        //Relay-2 ON or OFF all the time. 
        public static String CloseDoor()
        {
            return string.Format(BUZZER + "," + ROLE1, "OFF");
        }
        public static String CloseDoor(string message)
        {
            return string.Format(BUZZER + "," + ROLE1 + "," + LCDCLR + "," + LCDSET, "OFF", message);
        }
