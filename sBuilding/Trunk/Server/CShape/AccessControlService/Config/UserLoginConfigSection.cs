...
namespace sAccessControl.Config
{
    public class UserLoginConfigSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty("SaigonpearlCode", DefaultValue = 0, IsRequired = true)]
        [IntegerValidator(MinValue = 0)]
        public int SaigonpearlCode
        {
            get
            {
                return (int)this["SaigonpearlCode"];
            }
            set
            {
                this["SaigonpearlCode"] = value;
            }
        }
