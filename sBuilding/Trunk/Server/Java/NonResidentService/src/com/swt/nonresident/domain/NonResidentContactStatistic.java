...
@Entity
@Table(name = "swt_nonresident_contact_statistic")
@NamedNativeQueries({
		@NamedNativeQuery(name = "statisticNonresidentContactDetailByDateAndOrgId", query = "CALL statisticNonresidentContactDetailByDateAndOrgId(:start, :limit, :fromdate, :todate, :orgid)", resultClass = NonResidentContactStatistic.class) })
public class NonResidentContactStatistic implements Serializable{
	/**
	 * 
	 */
