namespace CampusModel.Exceptions
{
    ...
    public static class ErrorCodes
    {
        ...
        public const int TEACHER_NOT_FOUND = 1240;
        public const int TEACHER_PERSONALIZED = 1241;
        public const int FACULTY_NOT_FOUND = 1242;
        public const int DEPARTMENT_NOT_FOUND = 1243;
        public const int TEACHER_NOT_WORKING = 1244;
        public const int TEACHER_WORKING_ABROAD = 1245;
        public const int TEACHER_CONTRACT_END = 1246;
        ...
        public static string GetErrorMessage(int errorCode)
        {
            switch(errorCode)
            {
                ...
                case TEACHER_PROFILE_APP_NOT_PRESENT:
                    return "Thẻ không chứa thông tin giảng viên";
                case PERSO_EXPIRED:
                ...
                case TEACHER_NOT_FOUND:
                    return "Giảng viên không tồn tại trong hệ thống";
                case TEACHER_PERSONALIZED:
                    return "Giảng viên đã được cấp thẻ";
                case FACULTY_NOT_FOUND:
                    return "Khoa không tồn tại trong hệ thống";
                case DEPARTMENT_NOT_FOUND:
                    return "Bộ môn không tồn tại trong hệ thống";
                case TEACHER_NOT_WORKING:
                    return "Giảng viên đã nghỉ việc";
                case TEACHER_WORKING_ABROAD:
                    return "Giảng viên đang công tác nước ngoài";
                case TEACHER_CONTRACT_END:
                    return "Giảng viên đã hết hạn hợp đồng";
