...
namespace ParkingProcessComponent.Device.Reader.ACR120
{
    public class Acr120uWrapper
    {
        public const string DllName = "ACR120U.DLL";
        ...
        #region Reader port for AC_Open
        ...
        #endregion Reader port for AC_Open

        #region Key type for AC_Login
        ...
        #endregion Key type for AC_Login

        #region Wrapped reader commands
        ...
        #endregion Wrapped reader methods

        #region Wrapped card commands
        ...
        [DllImport(DllName)]
        public static extern int ACR120_ReadValue(int hReader, byte Block, ref long pValueData);

        [DllImport(DllName)]
        public static extern int ACR120_Write(int hReader, byte Block, ref byte pBlockData);

        [DllImport(DllName)]
        public static extern int ACR120_WriteValue(int hReader, byte Block, long ValueData);
        ...
        #endregion Wrapped card methods
    ...
    public struct tReaderStatus
    {
        ...
        /// <summary>
        /// 0x00 = Type A
        /// 0x01 = Type B TAG is being processed
        /// 0xFF = No TAG is being processed
        /// </summary>
        public byte CardOpMode;

        /// <summary>
        /// The current FWI value (time out value)
        /// </summary>
        public byte FWI;
