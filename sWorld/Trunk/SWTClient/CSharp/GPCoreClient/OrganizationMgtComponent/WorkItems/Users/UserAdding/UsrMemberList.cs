...
namespace SystemMgtComponent.WorkItems.UserAdding
{
    public partial class UsrMemberList : CommonUserControl, IUserAddingDialog
    {
        ...
        private void LoadLanguagesTable()
        {
            this.colTeacherCode.HeaderText = MessageValidate.GetMessage(rm, this.colTeacherCode.Name);
            this.colLastName.HeaderText = MessageValidate.GetMessage(rm, this.colLastName.Name);
            this.colFirstName.HeaderText = MessageValidate.GetMessage(rm, this.colFirstName.Name);
            this.colTitle.HeaderText = MessageValidate.GetMessage(rm, this.colTitle.Name);
            this.colPosition.HeaderText = MessageValidate.GetMessage(rm, this.colPosition.Name);
            this.colWorking.HeaderText = MessageValidate.GetMessage(rm, this.colWorking.Name);
        }
        #endregion
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxManager.ShowErrorMessageBox(this, MessageValidate.GetMessage(rm, "notseletemember"), MessageValidate.GetMessage(rm,"TitleError"));
                return;
            }
            ...
            {
                MessageBoxManager.ShowErrorMessageBox(this, MessageValidate.GetMessage(rm,"onlyonemember"), MessageValidate.GetMessage(rm,"Thao Tác Sai"));
                return;
            }
        }
