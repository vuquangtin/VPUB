...
namespace SystemMgtComponent.WorkItems.IntegratingExcel
{
    public partial class FrmIntegrateData : CommonControls.Custom.CommonDialog
    {
        ...
        private List<sWorldModel.TransportData.Member> MemberList;
        private List<sWorldModel.TransportData.Member> MemberErrorList;
        ...
        public FrmIntegrateData(List<sWorldModel.TransportData.Member> memberList)
        {
            InitializeComponent();
            InitDataGridView();
        ...
        private void bgwIntegrateData_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            int take = 100, skip = 0;
            List<sWorldModel.TransportData.Member> temp;
            MemberErrorList = new List<sWorldModel.TransportData.Member>();
        ...
        public void InitDataGridView()
        {
            ...
            dgvMemberErroList.Columns.Add(Title);
            ...
            dgvMemberErroList.Columns.Add(ColContactName);
            dgvMemberErroList.Columns.Add(ColContactPhone);
            dgvMemberErroList.Columns.Add(ColContactEmail);
            dgvMemberErroList.Columns.Add(ColContactAddress);
        }

        public void LoadDGVMemberErrorList(List<sWorldModel.TransportData.Member> memberList)
        {
            ...
            foreach (sWorldModel.TransportData.Member memberCus in memberList)
            {
                ...
                // tam thoi dong lai ??? 15.07.2016 
                //row[ColContactName.DataPropertyName] = memberCus.objMemRelative.FullName;
                //row[ColContactPhone.DataPropertyName] = memberCus.objMemRelative.Phone;
                //row[ColContactEmail.DataPropertyName] = memberCus.objMemRelative.Email;
                //row[ColContactAddress.DataPropertyName] = memberCus.objMemRelative.Address;
