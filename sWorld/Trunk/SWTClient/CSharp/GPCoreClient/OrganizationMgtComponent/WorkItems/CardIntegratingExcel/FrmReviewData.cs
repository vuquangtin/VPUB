...
{ 
    public partial class FrmReviewData : CommonControls.Custom.CommonDialog
    {
        ...
        private List<CardChipDto> cardChip { get; set; }
        ...
        public FrmReviewData(List<CardChipDto> cardChip, ResourceManager rm)
        {
            InitializeComponent();
            this.rmNew = rm;
...

        {
            ...
            {
                FrmIntegrateData frmIntegrateData = new FrmIntegrateData(cardChip);
