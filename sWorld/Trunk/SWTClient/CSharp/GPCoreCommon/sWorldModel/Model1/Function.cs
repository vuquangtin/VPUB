    ...
    public static class FunctionExtMethod
    {
        ...
        public static string GetName(this Function function)
        {
            switch (function)
            {
                ...
                case Function.FUNC_PERSO_PERSO_CARD:
                    return "Phát hành thẻ cho thành viên";
                ...
                case Function.MOD_MEMBER_MGT:
                    return "Quản lý thành viên";
                case Function.FUNC_MEMBER_VIEW:
                    return "Xem thông tin thành viên";
        ...
        public static string GetDescription(this Function function)
        {
            switch (function)
            {
                ...
                case Function.FUNC_PERSO_PERSO_CARD:
                    return "Chức năng này cho phép người dùng phát hành thẻ cho thành viên.";
                ...
                case Function.MOD_MEMBER_MGT:
                    return "Quản lý danh sách thành viên được tích hợp từ cơ sở dữ liệu của nhà trường.";
                case Function.FUNC_MEMBER_VIEW:
                    return "Chức năng này cho phép người dùng xem danh sách tổng quát các thành viên, lẫn thông tin chi tiết của một thành viên bất kỳ.";
                ...
                case Function.FUNC_TOOLKIT_READ_DATA:
                    return "Chức năng này cho phép người dùng đọc thông tin thành viên được lưu trên thẻ.";
                case Function.FUNC_TOOLKIT_UPDATE_DATA:
